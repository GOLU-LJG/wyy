<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\PHPTutorial\WWW\music/application/index\view\index\login.html";i:1610166092;s:81:"D:\phpStudy\PHPTutorial\WWW\music\application\index\view\index\common\header.html";i:1607951102;s:81:"D:\phpStudy\PHPTutorial\WWW\music\application\index\view\index\common\footer.html";i:1610166545;}*/ ?>
                                        ...
                                        <form>
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <img id="verify_img" src="<?php echo captcha_src(); ?>" alt="验证码" height="24px" onclick="refreshVerify()">
                                                </span>
                                                <input class="form-control" type="text" name="captcha" placeholder="请输入四位数字验证码">
                                            </div>
                                            <br>
