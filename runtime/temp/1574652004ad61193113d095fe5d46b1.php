<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\PHPTutorial\WWW\music/application/root\view\root\index.html";i:1610167238;s:79:"D:\phpStudy\PHPTutorial\WWW\music\application\root\view\root\common\header.html";i:1607932864;s:79:"D:\phpStudy\PHPTutorial\WWW\music\application\root\view\root\common\footer.html";i:1610166894;}*/ ?>
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form>
                            ...
                            <hr>
                            <div class="form-group">
                                <label class="col-xs-12">管理员密码</label>
                                <input type="text" name="pwd"  class="form-control" placeholder="请输入新的管理员密码" />
                            </div>
                            <button type="button" onclick="pwdEdit();" class="btn btn-app-red btn-block">修 改</button>
                        </form>
                    </div>
                </div>
            </div>
